...
public class SamplesEncoding
{
    ...
    //    foreach (EncodingInfo ei in Encoding.GetEncoding(57004))
        //Encoding e = Encoding.GetEncoding(57004);
        //var i = UnicodeEncoding.GetEncoding(57004));

         Console.WriteLine( "value {0}", '\u0B90');        
        {
        ...
        //    if (e.EncodingName.Contains("Tamil")) 
        //    {
